MANAGEABLE_COLLECTIONS = ['casts', 'users', 'chat', 'enrollment', 'stripe_customers', 'stripe_notifs', 'single_payments', 'stripe_subscriptions', 'subs', 'analytics', 'errors', 'emails_sent']
...
ADMIN_EMAILS = ['abelyael@gmail.com', 'tzlilberlin11@gmail.com', 'sella.rafaeli@gmail.com', 'galweinstock@icloud.com']
